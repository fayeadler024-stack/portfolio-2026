...
const projectDefinitions = [
  { title: 'Concrete', subtitle: '混凝土', category: 'Visual Design', count: 6, accent: '#713B20', description: 'A photography and social platform that brings image-making back to its everyday purpose: recording memories, sharing experiences, and finding resonance through other people’s stories.' },
  { title: 'Interstices of Cities', subtitle: '城市的缝隙', category: 'Creative Communication', count: 6, accent: '#59634F', description: 'An exhibition exploring urban villages and the lives of young people within them. The project considers these communities as places of arrival, adaptation, and belonging amid urban transformation.' },
  { title: 'Josie’s Daydream Album', subtitle: '乔希的白日梦相册', category: 'Book / Visual Design', count: 10, accent: '#75657C', description: 'A narrative book following Josie’s pursuit of a new life in the city. Through collage and visual storytelling, it explores the distance between aspiration, social expectations, and personal wellbeing.' },
